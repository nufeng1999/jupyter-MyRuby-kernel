...
class RubyKernel(MyKernel):
    ...
    implementation = 'jupyter_MyRuby_kernel'
    implementation_version = '1.0'
    language = 'Ruby'
    language_version = ''
    language_info = {'name': 'text/ruby',
                     'mimetype': 'text/ruby',
                     'file_extension': kernel_info['extension']}
    runfiletype='script'
    banner = "Ruby kernel.\n" \
             "Uses Ruby, compiles in ruby, and creates source code files and executables in temporary folder.\n"
    main_head = "\n" \
            "\n" \
...
##//%include:../../src/comm_attribute.py
    def __init__(self, *args, **kwargs):
        ...
        self.kernelinfo="[MyRubyKernel{0}]".format(time.strftime("%H%M%S", time.localtime()))
#################
