![](https://img.shields.io/badge/Jupyter-Kernel-green?link=https://jupyter.org/&link=https://github.com/jupyter/jupyter/wiki/Jupyter-kernels) ![](https://img.shields.io/badge/MyRuby-Kernel-orange) ![](https://img.shields.io/github/watchers/nufeng1999/jupyter-MyRuby-kernel) <img alt="ViewCount" src="https://views.whatilearened.today/views/github/nufeng1999/jupyter-MyRuby-kernel.svg">
    <a href="https://github.com/nufeng1999/jupyter-MyRuby-kernel"><img alt="GitHub Clones" src="https://img.shields.io/badge/dynamic/json?color=success&label=Clone&query=count&url=https://raw.githubusercontent.com/nufeng1999/jupyter-MyRuby-kernel/master/clone.json&logo=github"></a>
# MyRuby kernel for Jupyter  
  
[Example](https://github.com/nufeng1999/jupyter-MyRuby-kernel/blob/master/example/MyRuby.ipynb "Example")
...
### Step-by-step
```bash
git clone https://github.com/nufeng1999/jupyter-MyRuby-kernel.git
cd jupyter-MyRuby-kernel
pip install -e . 
cd jupyter_MyRuby_kernel && python3 install_MyRuby_kernel --user
